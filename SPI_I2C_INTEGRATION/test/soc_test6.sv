class soc_test6 extends uvm_test;
	`uvm_component_utils(soc_test6)

  soc_env envh;
  soc_env_config sicfg;
  soc_virtual_sequence5 vseq;
  ...
  function void build_phase(uvm_phase phase);
	...
	vseq = soc_virtual_sequence5::type_id::create("vseq");
  endfunction

  task run_phase(uvm_phase phase);
	phase.raise_objection(this);
	`uvm_info(get_type_name(),"soc_test6: SPI + I2C max boundary read",UVM_NONE)
