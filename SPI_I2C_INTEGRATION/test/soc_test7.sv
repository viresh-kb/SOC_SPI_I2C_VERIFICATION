class soc_test7 extends uvm_test;
	`uvm_component_utils(soc_test7)

  soc_env envh;
  soc_env_config sicfg;
  soc_virtual_sequence6 vseq;
  ...
  function void build_phase(uvm_phase phase);
	...
	vseq = soc_virtual_sequence6::type_id::create("vseq");
  endfunction

  task run_phase(uvm_phase phase);
	phase.raise_objection(this);
	`uvm_info(get_type_name(),"soc_test7: SPI + I2C write then read same address",UVM_NONE)
